...
namespace Epam.FixAntenna.Common
{
	...
	public class DateTimeHelperTest
	{
		public static object[] TestCases = {
			...
			new object[] { "  UTC+10:00  ", true, new TimeSpan(10, 0, 0), null},
			...
			new object[] { "OAT", false, TimeSpan.Zero, null},
			new object[] { "UTC+730", false, TimeSpan.Zero, null},
			new object[] { "UTC+73:045", false, TimeSpan.Zero, null},
			new object[] { "UTC+15", false, TimeSpan.Zero, null},
			new object[] { "UTC-15", false, TimeSpan.Zero, null},
			new object[] { "UTC+1000", false, TimeSpan.Zero, null},
			new object[] { "xUTC+10:00", false, TimeSpan.Zero, null},
			new object[] { "UTC+10:00x", false, TimeSpan.Zero, null},
			new object[] { "xUTC+10:00x", false, TimeSpan.Zero, null},
			new object[] { "365UTC20", false, TimeSpan.Zero, null},
