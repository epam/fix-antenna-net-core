...
{
	[TestFixture]
	internal class Validate40DataTest : GenericValidationTestStub
	{
		[TearDown]
		...
		{
			return new FixInfo(FixVersion.Fix40);
		}

		[Test]
		[TestCaseSource(nameof(GetResourcePaths), new object[] { "fixdatafix40" })]
		...
		[Test]
		[TestCaseSource(nameof(GetResourcePaths), new object[] { "FIX40" })]
