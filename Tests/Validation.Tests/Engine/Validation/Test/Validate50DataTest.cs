...
{
	[TestFixture]
	internal class Validate50DataTest : GenericValidationTestStub
	{
		[TearDown]
		...
		private static readonly ILog Log = LogFactory.GetLog(typeof(Validate50DataTest));
		...
		[Test]
		[TestCaseSource(nameof(GetResourcePaths), new object[] { "fixdatafix50." })]
		...
		[Test]
		[TestCaseSource(nameof(GetResourcePaths), new object[] { "FIX50." })]
