...
{
	[TestFixture]
	internal class Validate44DataTest : GenericValidationTestStub
	{
		[TearDown]
		...
		private static readonly ILog Log = LogFactory.GetLog(typeof(Validate44DataTest));
		...
		[Test]
		[TestCaseSource(nameof(GetResourcePaths), new object[] { "fixdatafix44" })]
		...
		[Test]
		[TestCaseSource(nameof(GetResourcePaths), new object[] { "FIX44." })]
