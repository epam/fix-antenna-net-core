...
{
	[TestFixture]
	internal class TestInvalidConditionally50Sp1 : InvalidValidationTestStub
	{
		private const string PackagePrefix = "resources/messages_multiplevalue_50sp1sp2_all/";

		public override FixInfo GetFixInfo()
		{
			return new FixInfo(FixVersion.Fixt11, FixVersion.Fix50Sp1);
		}

		[Test]
		public virtual void InvalidConditionalTest1()
		{
			InvalidTest(FixVersion.Fix50, PackagePrefix + "invalid_multipleCHARvalue_50sp1sp2.fix");
		}

		[Test]
		public virtual void InvalidConditionalTest2()
		{
			InvalidTest(FixVersion.Fix50, PackagePrefix + "invalid_multipleSTRINGvalue_50sp1sp2.fix");
		}
	}
}