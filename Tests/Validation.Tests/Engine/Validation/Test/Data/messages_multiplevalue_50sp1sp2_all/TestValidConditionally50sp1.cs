...
{
	[TestFixture]
	internal class TestValidConditionally50Sp1 : ValidValidationTestStub
	{
		...
		{
			ValidTest(FixVersion.Fix50Sp1, PackagePrefix + "valid_multipleCHARvalue_50sp1sp2.fix");
		}

		[Test]
		public virtual void InvalidConditionalTest2()
		{
			ValidTest(FixVersion.Fix50Sp1, PackagePrefix + "valid_multipleSTRINGvalue_50sp1sp2.fix");
		}
	}
}