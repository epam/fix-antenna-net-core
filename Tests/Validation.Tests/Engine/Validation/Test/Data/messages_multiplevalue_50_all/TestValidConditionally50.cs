...
{
	[TestFixture]
	internal class TestValidConditionally50 : ValidValidationTestStub
	{
		private const string PackagePrefix = "resources/messages_multiplevalue_50_all/";

		public override FixInfo GetFixInfo()
		{
			return new FixInfo(FixVersion.Fixt11, FixVersion.Fix50);
		}

		[Test]
		public virtual void InvalidConditionalTest1()
		{
			ValidTest(FixVersion.Fix50, PackagePrefix + "valid_multipleCHARvalue_50.fix");
		}

		[Test]
		public virtual void InvalidConditionalTest2()
		{
			ValidTest(FixVersion.Fix50, PackagePrefix + "valid_multipleSTRINGvalue_50.fix");
		}
	}
}