...
{
	[TestFixture]
	public class RegExpFlexibleComparatorTest
	{
		internal RegExpFlexibleComparator RegexpFlexibleComparator;

		[SetUp]
		public virtual void SetUp()
		{
			RegexpFlexibleComparator = new RegExpFlexibleComparator();
			RegexpFlexibleComparator.SetMessageSeparator("#");
		}
		...
		public virtual void TestIsEquals()
		{
			...
			RegexpFlexibleComparator.SetEtalonMessage(message2);
			ClassicAssert.AreEqual(true, RegexpFlexibleComparator.IsMessageOk(message));
		}
		...
		public virtual void TestIsNotEqualsByValues()
		{
			...
			RegexpFlexibleComparator.SetEtalonMessage(message2);
			ClassicAssert.AreEqual(false, RegexpFlexibleComparator.IsMessageOk(message));
		}

		[Test]
		public virtual void TestHackIsNotEqualsBlankToAny()
		{
			string message = "8=FIX.4.2\x00019=115\x000135=A\x000149=ADAPTOR\x000156=123\x000134=1\x000150=SENDERSUBID\x0001142=SENDERLOCATIONID\x000157=TARGETSUBID\x000152=20040219-11:02:43.334\x000198=0\x0001108=0\x000110=207\x0001";
			string message2 = "";
			RegexpFlexibleComparator.SetEtalonMessage(message2);
			ClassicAssert.AreEqual(false, RegexpFlexibleComparator.IsMessageOk(message)); // "shouldn't be equals because blank message expects blank message"
		}
	}
}