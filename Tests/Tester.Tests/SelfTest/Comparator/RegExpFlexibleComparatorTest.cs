...
namespace Epam.FixAntenna.Tester.SelfTest
{
	...
	public class RegExpFlexibleComparatorTest
	{
		...
		public virtual void TestIsEquals()
		{
			...
			Assert.AreEqual(true, RegexpFlexibleComparator.IsMessageOk(message));
		}
		...
		public virtual void TestIsNotEqualsByValues()
		{
			...
			RegexpFlexibleComparator.SetEtalonMessage(message2);
			Assert.AreEqual(false, RegexpFlexibleComparator.IsMessageOk(message));
		}
		...
		public virtual void TestHackIsNotEqualsBlankToAny()
		{
			...
			string message2 = "";
			RegexpFlexibleComparator.SetEtalonMessage(message2);
			Assert.AreEqual(false, RegexpFlexibleComparator.IsMessageOk(message)); // "shouldn't be equals because blank message expects blank message"
		}
	}
}