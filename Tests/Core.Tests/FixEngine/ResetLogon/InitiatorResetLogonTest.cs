...
{
	[TestFixture]
	internal class InitiatorResetLogonTest : AbstractInitiatorResetTst
	{
		[Test]
		public virtual void TestReceiveResetLogon()
		{
			ResetSeqNums();
		...
		[Test]
		public virtual void TestReceiveAndSendResetLogon()
		{
			ResetSeqNums();
