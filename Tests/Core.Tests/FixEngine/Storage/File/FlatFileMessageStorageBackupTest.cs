...
{
	internal class FlatFileMessageStorageBackupTest : AbstractMessageStorageTest
	{
		private readonly ILog _log;

		public FlatFileMessageStorageBackupTest()
		{
		...
		{
			private readonly FlatFileMessageStorageBackupTest _outerInstance;

			public FileHelper(FlatFileMessageStorageBackupTest outerInstance)
			{
