...
namespace Epam.FixAntenna.Message.Tests.Format
{
	...
	internal class TzTimeSecondsFormatterTest : GenericDateFormatterTst
	{
		...
		public virtual void TestFormattedStringLengthForHourTz()
		{
			...
			Assert.AreEqual("HH:MM:SS-hh".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForMinTz()
		{
			...
			Assert.AreEqual("HH:MM:SS-hh:mm".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForUtc()
		{
			...
			Assert.AreEqual("HH:MM:SSZ".Length, FixDateFormatter.GetFormattedStringLength(cal), "Wrong format length");
		}
