...
{
	[TestFixture]
	internal class TzTimeMillisFormatterTest : GenericDateFormatterTst
	{
		internal TzTimeMillisFormatter FixDateFormatter = new TzTimeMillisFormatter();
		...
		public virtual void TestFormattedStringLengthForHourTz()
		{
			...
			ClassicAssert.AreEqual("HH:MM:SS.sss-hh".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForMinTz()
		{
			...
			ClassicAssert.AreEqual("HH:MM:SS.sss-hh:mm".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForUtc()
		{
			...
			ClassicAssert.AreEqual("HH:MM:SS.sssZ".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		{
			var cal = CalendarHelper.GetUtcShiftedTestCalendar(TimeSpan.FromHours(-2));
			CheckFormat(FixDateFormatter, cal, "23:59:59.999-02");
		}
		...
		{
			var cal = CalendarHelper.GetUtcShiftedTestCalendar(TimeSpan.FromMinutes(-150));
			CheckFormat(FixDateFormatter, cal, "23:59:59.999-02:30");
		}
		...
		{
			var cal = CalendarHelper.GetUtcTestCalendar();
			CheckFormat(FixDateFormatter, cal, "23:59:59.999Z");
		}
	}
}