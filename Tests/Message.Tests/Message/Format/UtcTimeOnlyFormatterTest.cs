...
{
	[TestFixture]
	internal class UtcTimeOnlyFormatterTest : GenericDateFormatterTst
	{
		internal UtcTimeOnlyFormatter FixDateFormatter = new UtcTimeOnlyFormatter();

		[Test]
		public virtual void TestFormattedStringLength()
		{
			ClassicAssert.AreEqual("HH:MM:SS".Length, FixDateFormatter.GetFormattedStringLength(DateTime.Now),
				"Wrong format length");
		}
		...
		public virtual void TestNonUtcCalendarFormat()
		{
			...
			CheckFormat(FixDateFormatter, cal, "01:59:59");
		}
		...
		public virtual void TestUtcCalendarFormat()
		{
			...
			CheckFormat(FixDateFormatter, cal, "23:59:59");
		}
	}
}