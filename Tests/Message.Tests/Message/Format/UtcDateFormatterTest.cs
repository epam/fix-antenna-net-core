...
{
	[TestFixture]
	internal class UtcDateFormatterTest : GenericDateFormatterTst
	{
		internal UtcDateFormatter FixDateFormatter = new UtcDateFormatter();

		[Test]
		public virtual void TestFormattedStringLength()
		{
			ClassicAssert.AreEqual("YYYYMMDD".Length, FixDateFormatter.GetFormattedStringLength(DateTime.Now),
				"Wrong format length");
		}
