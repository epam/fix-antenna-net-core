...
namespace Epam.FixAntenna.Message.Tests.Format
{
	...
	internal class TzTimestampMillisFormatterTest : GenericDateFormatterTst
	{
		...
		public virtual void TestFormattedStringLengthForHourTz()
		{
			...
			Assert.AreEqual("YYYYMMDD-HH:MM:SS.sss-hh".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForMinTz()
		{
			...
			Assert.AreEqual("YYYYMMDD-HH:MM:SS.sss-hh:mm".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForUtc()
		{
			...
			Assert.AreEqual("YYYYMMDD-HH:MM:SS.sssZ".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
