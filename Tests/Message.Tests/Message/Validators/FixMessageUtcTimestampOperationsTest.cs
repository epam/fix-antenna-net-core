...
{
	internal class FixMessageUtcTimestampOperationsTest : AbstractGetTagValueAsXxxDateValidator
	{
		private static readonly string[] Times = { "19981231-23:59:59", "19980101-12:01:59.999" };
		...
		{
			FixDateFormatterFactory.FixDateType.UtcTimestampShort,
			FixDateFormatterFactory.FixDateType.UtcTimestampWithMillis
		};

		public FixMessageUtcTimestampOperationsTest()
		{
			UtcCalendars[0] = new DateTimeOffset(1998, 12, 31, 23, 59, 59, TimeSpan.Zero);
			UtcCalendars[1] = new DateTimeOffset(1998, 1, 1, 12, 1, 59, 999, TimeSpan.Zero);
		}
