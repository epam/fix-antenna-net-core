...
namespace Epam.FixAntenna.Message.Tests.Format
{
	...
	internal class TzTimeMillisFormatterTest : GenericDateFormatterTst
	{
		...
		public virtual void TestFormattedStringLengthForHourTz()
		{
			...
			Assert.AreEqual("HH:MM:SS.sss-hh".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForMinTz()
		{
			...
			Assert.AreEqual("HH:MM:SS.sss-hh:mm".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
		...
		public virtual void TestFormattedStringLengthForUtc()
		{
			...
			Assert.AreEqual("HH:MM:SS.sssZ".Length, FixDateFormatter.GetFormattedStringLength(cal),
				"Wrong format length");
		}
