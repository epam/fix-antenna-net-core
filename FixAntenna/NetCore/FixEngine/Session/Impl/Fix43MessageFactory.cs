...
namespace Epam.FixAntenna.NetCore.FixEngine.Session.Impl
{
	...
	/// </summary>
	internal class Fix43MessageFactory : StandardMessageFactory
	{
		/// <inheritdoc />
		...
		{
			return base.GetRejectForMessageTag(rejectMessage, refTagId, rejectReason > 17 ? -1 : rejectReason, rejectText);
		}
	}
}