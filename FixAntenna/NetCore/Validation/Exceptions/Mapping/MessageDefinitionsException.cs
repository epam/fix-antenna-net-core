...
namespace Epam.FixAntenna.NetCore.Validation.Exceptions.Mapping
{
	internal class MessageDefinitionsException : CommonValidationException
	{
		/// <summary>
		...
		public MessageDefinitionsException(FixError validationError, Exception cause) : base(validationError, cause)
		{
		}
	}
}