...
namespace Epam.FixAntenna.NetCore.Validation.Validators.Condition.Operators
{
	...
	/// </summary>
	internal class AndValidateOperator : AbstractCondition
	{
		...
		///  </param>
		public AndValidateOperator(ICondition operand1, ICondition operand2, bool isGroup) : base(isGroup)
		{
			_operand1 = operand1;
			_operand2 = operand2;
		}
		...
		{
			var isValidOper2 = _operand2.ValidateCondition(validateTag, msg, msgType, tagsMap, inversion);
			var isValidOper1 = _operand1.ValidateCondition(validateTag, msg, msgType, tagsMap, inversion);
			return isValidOper1 || isValidOper2;
		}
