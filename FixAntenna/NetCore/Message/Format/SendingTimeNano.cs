...
{
	internal class SendingTimeNano : ISendingTime
	{
		private static int Length = 27;
		...
		public virtual byte[] CurrentDateValue
		{
			get
			{
				...
				var fractions = ticks % 10000 * 100;

				FixTypes.FormatTimestamp(_sendingTimeBuf, 0, date, fractions, TimestampPrecision.Nano);
